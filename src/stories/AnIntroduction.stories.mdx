...
- Since all components have the single source of truth. They can be altered without changing a single line of code in the consumer application.
...
- Source code - https://github.com/samuellawerentz/style-guide