...
var SimpleBar$1 = require('simplebar-react');
...
var SimpleBar__default$1 = /*#__PURE__*/_interopDefaultLegacy(SimpleBar$1);
...
var css_248z$d = ".sg.contacto-icon {\n  user-select: none;\n  display: inline-block; }\n\n.sg.contacto-loader {\n  border-radius: 50%;\n  position: relative;\n  display: inline-block;\n  line-height: 0;\n  animation: rotate-loading 1s infinite linear; }\n\n@keyframes rotate-loading {\n  to {\n    transform: rotate(360deg); } }\n";
styleInject(css_248z$d);

var _excluded$c = ["className", "name", "size", "color", "style", "hoverColor"];
...
var _excluded$a = ["type", "children", "className", "variant", "color", "style", "align"];
/**
...
var css_248z$4 = ".sg.contacto-table-inner-wrapper {\n  display: flex;\n  flex-direction: column;\n  min-height: 0;\n  flex: 1;\n  height: 100%; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-item {\n    display: none; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-spin-blur {\n    overflow: visible; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-pagination.ant-pagination {\n    margin: 0;\n    position: absolute;\n    right: 16px;\n    align-items: center;\n    top: -16px;\n    transform: translateY(-100%); }\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-pagination.ant-pagination .ant-pagination-total-text,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-pagination.ant-pagination .material-icons-round {\n      line-height: 36px;\n      height: 36px; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-prev,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-next {\n    height: auto;\n    min-width: auto;\n    line-height: initial;\n    color: var(--gray-1); }\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-prev.ant-pagination-disabled,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-next.ant-pagination-disabled {\n      color: var(--gray-3); }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-total-text,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-pagination-prev {\n    margin-right: 16px; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > th,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > td,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > th,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > td,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > th,\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > td {\n    padding: 16px 8px; }\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > th:first-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > td:first-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > th:first-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > td:first-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > th:first-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > td:first-child {\n      padding-left: 16px; }\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > th:last-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > td:last-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > th:last-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr > td:last-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > th:last-child,\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table tfoot > tr > td:last-child {\n      padding-right: 16px; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > th {\n    background: var(--gray-6);\n    color: var(--gray-1);\n    font-weight: 400;\n    padding-top: 8px;\n    padding-bottom: 8px;\n    line-height: 20px;\n    border: none;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap; }\n    .sg.contacto-table-inner-wrapper .contacto-table .ant-table-thead > tr > th:before {\n      display: none; }\n  .sg.contacto-table-inner-wrapper .contacto-table .ant-table-tbody > tr.ant-table-row:hover > td {\n    background-color: var(--background-highlight-color); }\n  .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper {\n    height: 100%; }\n    .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading {\n      height: 100%; }\n      .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading .ant-spin-container {\n        height: 100%;\n        display: flex;\n        flex-flow: column nowrap; }\n        .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading .ant-spin-container .ant-table {\n          flex: auto;\n          overflow: hidden; }\n          .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading .ant-spin-container .ant-table .ant-table-container {\n            height: 100%;\n            display: flex;\n            flex-flow: column nowrap; }\n            .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading .ant-spin-container .ant-table .ant-table-container .ant-table-header {\n              flex: none;\n              overflow: hidden;\n              position: sticky;\n              top: 0;\n              z-index: 10; }\n            .sg.contacto-table-inner-wrapper .contacto-table.ant-table-wrapper .ant-spin-nested-loading .ant-spin-container .ant-table .ant-table-container .ant-table-body {\n              display: flex;\n              flex-direction: column;\n              min-height: 0;\n              overflow-y: hidden !important; }\n";
styleInject(css_248z$4);

var _excluded$3 = ["className", "pagination", "dataSource", "onChange"];
/**
...
var Table = function Table(_ref) {
  ...
  React.useEffect(function () {
    new SimpleBar__default['default'](tableRef.current.querySelector('.ant-table-container'));
  }, []);

  var handleChange = function handleChange() {
    onChange && onChange.apply(void 0, arguments);
    var simpleBar = SimpleBar__default['default'].instances.get(tableRef.current.querySelector('.ant-table-container'));
    var el = simpleBar && simpleBar.getScrollElement();
    if (el) el.scrollTop = 0;
  };

  return /*#__PURE__*/React__default['default'].createElement("div", {
    ref: tableRef,
    className: ['sg contacto-table-inner-wrapper', className].join(' ')
...
Table.propTypes = {
   ...
   */
  className: PropTypes__default['default'].string,
  dataSource: PropTypes__default['default'].any,
  onChange: PropTypes__default['default'].any
};

var css_248z$3 = ".sg.contacto-table-layout .contacto-table-layout--controls {\n  margin-bottom: 16px; }\n";
...
var _excluded$2 = ["className"],
    _excluded2 = ["className", "spacing", "style"];
...
var Scrollable = function Scrollable(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleBar__default$1['default'], _extends({
...
var Sider = function Sider(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(antd.Layout.Sider, _extends({
    ...
    className: "material-icons-round contacto-sider-close-icon",
    onClick: onClose
  }, "close"))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "contacto-sider-content"
  }, /*#__PURE__*/React__default['default'].createElement(Block.Scrollable, {
    className: "contacto-sider-content-scroll"
